...
Last updated: 2026-05-06 01:03 America/Chicago
...
3. The schedule has now improved over tuned Leon-family baselines but not original Muon. Since `lr=0.03,ramp=0.5->0.8` regressed, continue bracketing timing at `lr=0.0275`: next high-value probes are `ramp=0.6->0.9`, `0.4->0.7`, and `0.6->0.95`.

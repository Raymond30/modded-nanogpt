...
Last updated: 2026-05-06 00:20 America/Chicago
...
| Schedule/LR sweep | `schedule1500_lr0225_wd025_b270_mu095_ramp030060_4gpu` | First point in the 30-run grid. Lower LR plus a 30%-60% ramp helped mid-training versus Leon-family controls but faded by final, ending at `3.45287`. |
...
3. The `leon_l_scale` schedules tested so far have not improved final validation loss. The Muon-hparams `0.5 -> 0.8` ramp suggests delayed `L` can help mid-training, while the new `lr=0.0225,ramp=0.3->0.6` point suggests too-low LR fades late. Continue the declared schedule/LR grid, with special attention to `lr=0.025` and `0.0275` plus later ramp starts before spending more time below Muon LR.

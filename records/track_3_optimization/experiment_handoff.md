...
Last updated: 2026-05-06 00:35 America/Chicago
...
| Schedule/LR sweep | `schedule1500_lr0225_wd025_b270_mu095_ramp030060_4gpu`, `schedule1500_lr025_wd025_b270_mu095_ramp030060_4gpu` | First two points in the 30-run grid. The 30%-60% ramp gave transient mid-training gains versus Leon-family controls, but `lr=0.0225` faded to `3.45287` and Muon-LR `0.025` faded less to `3.45046`, still behind the later `0.5->0.8` ramp and all Muon references. |
...
3. The `leon_l_scale` schedules tested so far have not improved final validation loss. The Muon-hparams `0.5 -> 0.8` ramp remains the best schedule result so far, while the `0.3 -> 0.6` ramp improved when LR moved from `0.0225` to `0.025` but still faded late. Continue the declared schedule/LR grid, prioritizing later ramp starts and `lr=0.025-0.0275` before spending more time below Muon LR.
